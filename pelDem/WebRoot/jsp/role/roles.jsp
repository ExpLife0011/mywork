...
<form action="role.html" method="post" name=""roleForm"" id="roleForm">
    ...
    <table class="tablelist">
    	<thead>
    	<tr>
	        <th><input name="sltAll" id="sltAll" type="checkbox" value="" onclick="sltAllRole()"/></th>
        ...
        <c:choose>
			<c:when test="${not empty roleList}">
				...
				<tr>
				<td><input type="checkbox" name="roleIds" id="roleIds${role.roleId }" value="${role.roleId }"/></td>
				<td>${vs.index+1}</td>
